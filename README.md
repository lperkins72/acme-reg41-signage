...
```text
?tenant=acme&region=reg41&device=nuc-001
```

Example:

```text
https://<deployment-domain>/?tenant=acme&region=reg41&device=nuc-001
```
...
5. test one launcher such as `/devices/reg41/nuc-001.html`
